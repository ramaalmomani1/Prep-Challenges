...
const objLat = (obj) => {
   ...
   let personInfo = 
 `my name is ${obj.firstName[0].toUpperCase() + obj.firstName.slice(1)} ${obj.lastName[0].toUpperCase() + obj.lastName.slice(1)} I am ${obj.age} YO, and I love ${obj.hobby}.`
        return(personInfo)
 }; 
...
//     hobby: hobby,
//     personInfo: function (){ 
//         return `my name is ${obj.firstName[0].toUpperCase() + obj.firstName.slice(1).toLowerCase}
//         ${obj.lastName[0].toUpperCase() + obj.lastName.slice(1).toLowerCase} I am ${obj.age} YO, and I love ${obj.hobby}.`
//     } } 

// `my name is ${obj.firstName === obj.firstName.toLowerCase ? obj.firstName.charAt(0) +  obj.firstName.slice(1) : obj.firstName }
//         ${obj.lastName === obj.lastName.toLowerCase ? obj.lastName.charAt(0) +  obj.lastName.slice(1): obj.lastName} I am ${obj.age} YO, and I love ${obj.hobby}.`
//     }  

// `my name is ${obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1)}
//         ${obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1)} I am ${obj.age} YO, and I love ${obj.hobby}.`
// -------------------------------------------------------------------------------------------------------
...
const cvFormatter = (arr) => {
    ...
    for(let i=0 ; i<arr.length ;i++){
        ...
        if (arr[i].yearsOfExperience > 1){
         ...
         fullName = arr[i].firstName&&arr[i].lastName ? `${arr[i].firstName} ${arr[i].lastName}` : arr[i].firstName||arr[i].lastName;
