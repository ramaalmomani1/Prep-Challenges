...
const employeesBonus = (arr) => {
    ...
    // parseFloat(n.salary) +100
        // const any = n.salary
        const splitPosition = n.salary.split('$');
         n.salary= parseInt(splitPosition[0]) + 100 + '$'
        // let addedValue = convertToNum + 100 + '$'
            ...
            // const any = n.salary
            const splitPosition = n.salary.split('$');
             n.salary=  parseInt(splitPosition[0]) + 50 +'$'
            // let addedValue = convertToNum + 50 +'$'
        }
        result.push(n)  
    })
    return result;
